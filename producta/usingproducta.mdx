...
icon: "stopwatch"
description: "Instructions to setup and start using Producta"
---

## How to use Producta

<Tip>
  If you haven't signed up for a Producta account, read[ this documentation](http://localhost:3008/onboarding) to get started.
</Tip>
